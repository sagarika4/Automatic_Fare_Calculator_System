...
def loadKNNDataAndTrainKNN():
    ...
    kNearest.setDefaultK(15)                                                             # set default K to 1
...
def detectCharsInPlates(listOfPossiblePlates):
    ...
    if license_plate.showSteps == True:
...
def findListOfListsOfMatchingChars(listOfPossibleChars):
    ...
    for possibleChar in listOfPossibleChars:                        # for each possible char in the one big list of chars
        ...
        #print("printing lists" +str(listOfMatchingChars))
...
def recognizeCharsInPlate(imgThresh, listOfMatchingChars):
    ...
    for currentChar in listOfMatchingChars:                                         # for each char in plate
        ...
        cv2.rectangle(imgThreshColor, pt1, pt2, license_plate.SCALAR_GREEN, 2)           # draw green box around the char
